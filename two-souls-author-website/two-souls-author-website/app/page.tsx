...
const books = [
  { n: 'Book One', title: 'The First Breath', tagline: 'The moment the soul remembers.', image: '/books/book-1.png', desc: 'A first recognition. A breath before language. The beginning of a pull neither soul asked for, but neither could forget.' },
  { n: 'Book Two', title: 'What I Could Not Stop', tagline: 'Some pulls are stronger than will.', image: '/books/book-2.png', desc: 'Desire becomes gravity. Silence becomes a room they both keep entering, even when they know they should turn away.' },
  { n: 'Book Three', title: 'Quietly Undone', tagline: 'The self I knew is slipping away.', image: '/books/book-3.png', desc: 'The breaking is not loud. It is the soft dismantling of the version of her who survived by staying small.' },
  { n: 'Book Four', title: 'Surrendering', tagline: 'We were never apart. Only afraid to see.', image: '/books/book-4.png', desc: 'Two souls stand at the edge of what they have denied, learning that surrender is not weakness. It is truth.' },
  { n: 'Book Five', title: 'She Rises', tagline: 'She remembered who she was.', image: '/books/book-5.png', desc: 'Fire returns to the body. The woman who once waited for permission becomes the flame that names herself.' },
  { n: 'Book Six', title: 'Without End', tagline: 'Love does not end. It becomes everything.', image: '/books/book-6.png', desc: 'The final tide. The last becoming. A love that moves beyond possession into peace, memory, and forever.' },
]
